...
import { getOrderBalance, isOrderPaid } from "../utils/paymentCalculation";
...
export default function Reports({ orders, payments, isLoading }: ReportsProps) {
          ...
          <Card title="Monthly Revenue">
            ...
            <div className="flex items-end gap-4 h-[220px] pt-4">
              {[
                ...
                >
                  <div
                    className="w-full max-w-9 rounded-t-md bg-primary"
